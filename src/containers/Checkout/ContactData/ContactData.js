...
class ContactData extends React.Component {
    ...
    inputChangedHandler = (e, inputIdentifier) => {
        ...
        // inputIdentifier = email, country, deliveryMethod...
        ...
        for(let inputIdentifier in updatedFormElement){
            formIsValid = updatedFormElement[inputIdentifier] && formIsValid;
    ...
    orderHandler = e => {
        ...
        this.props.onBurgerOrder(burgerOrder);
...
const mapDispatchToProps = dispatch =>{
    ...
    return {
        onBurgerOrder: (orderData)=> {dispatch(burgerOrderActions.purchaseBurger(orderData))}
    }
}
